/**
 * Stripe Client using Replit Connection API
 * 
 * This module fetches Stripe credentials from Replit's secure connection API
 * and provides properly configured Stripe clients.
 * 
...
/**
 * Get a fresh Stripe client - do not cache this
