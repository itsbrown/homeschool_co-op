...
const MIGRATION = "server/migrations/260-family-calendar.sql";

/** Idempotent apply of family-calendar migration (E2E + local). */
export async function ensureFamilyCalendarSchema(): Promise<void> {
  if (ensured) return;
