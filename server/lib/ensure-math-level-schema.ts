...
const MIGRATION = "server/migrations/264-children-math-level.sql";

/** Idempotent apply of children.current_math_level + Math Level assessment type. */
export async function ensureMathLevelSchema(): Promise<void> {
  if (ensured) return;
