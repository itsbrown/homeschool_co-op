...
// Password Reset Email using Brevo
...
// Staff Invitation Email using Brevo
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #ffffff; padding: 32px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb;">
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="${process.env.APP_URL || 'https://accounts.americanseekersacademy.com'}/cart/checkout" 
...
Complete payment at: ${process.env.APP_URL || 'https://accounts.americanseekersacademy.com'}/cart/checkout
    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #ffffff; padding: 32px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb;">
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="${process.env.APP_URL || 'https://accounts.americanseekersacademy.com'}/schools/students" 
