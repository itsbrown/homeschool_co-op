        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Import contacts and convert them into user accounts
            </p>
          </div>
        </div>
          ...
          <TabsContent value="upload" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select multiple CSV files to import contacts and account data. Files will be automatically processed based on their names.
                </CardDescription>
              </CardHeader>
                  ...
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg space-y-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div className="text-center p-2 bg-white rounded border">
                        ...
                        <div className="text-muted-foreground">Children Added</div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-medium mb-2">Children CSV Format:</h4>
                    <div className="bg-gray-50 p-2 rounded text-xs font-mono">
              ...
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <h4 className="font-medium">Account Creation Process:</h4>
                      <ol className="space-y-2 text-sm text-muted-foreground">
                        <li className="flex gap-2">
                          ...
                          <span>User records are created in the system</span>
                        </li>
                        <li className="flex gap-2">
                          ...
                          <span>Authentication accounts are set up</span>
                        </li>
                        <li className="flex gap-2">
                          ...
                          <span>Temporary passwords are generated (for staff)</span>
                        </li>
                        <li className="flex gap-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li className="flex items-center gap-2">
                          ...
                          <span>Users receive email invitations</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <UserPlus className="h-4 w-4" />
                          <span>Accounts are ready for login</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <Users className="h-4 w-4" />
                          <span>Manage users in the Users section</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <Check className="h-4 w-4" />
                          <span>Review import results and errors</span>
                        </li>
                      </ul>
                    </div>
                  </div>
