...
export default function SchoolClassesUploadPage() {
  ...
  const handleMappingConfirm = async (mapping: Record<string, string>) => {
    ...
    try {
      ...
      setTimeout(() => setLocation("/schools/classes"), 2000);
    } catch (error: any) {
  ...
  return (
    <SchoolAdminLayout pageTitle="Import Classes">
      <div className="container mx-auto p-4">
        <div className="max-w-5xl mx-auto p-6">
          <div className="flex flex-col space-y-6">
            <div className="flex items-center gap-2">
              <Button variant="outline" size="icon" onClick={() => setLocation("/schools/classes")} className="h-8 w-8">
                <ArrowLeft className="h-4 w-4" />
              </Button>
              <h2 className="text-2xl font-bold tracking-tight">Import Classes from CSV</h2>
            </div>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-end gap-2">
                        <Button variant="outline" onClick={() => setLocation("/schools/classes")}>
                          Cancel
                        </Button>
