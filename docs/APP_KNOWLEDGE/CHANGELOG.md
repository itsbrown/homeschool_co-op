...
- Fix: defer confirm open, bind Select to pending selection, confirm with plain Button; E2E `e2e/parent-profile-campus-change.spec.ts` (`setup-cart-scenario` `withCampuses`).
