...
| [domains/schedule-and-lesson-planning.md](./domains/schedule-and-lesson-planning.md) | Week templates/plans, lesson teaching details (description/objectives/materials), parent Calendar hub (`/schedule`), family ICS, school-admin events |
