...
- **Supply lists** pick these same products (class/session editor → shop product dropdown). See [supply-lists.md](./supply-lists.md). Do not duplicate affiliate URLs on `supply_items`.
