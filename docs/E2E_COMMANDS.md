...
| [`e2e/parent-class-allergy-alert.spec.ts`](../e2e/parent-class-allergy-alert.spec.ts) | `npm run test:e2e -- e2e/parent-class-allergy-alert.spec.ts` | Classmate parent dashboard allergy reminder + inbox notice; never names the allergic student | `setup-class-allergy-scenario` (`linkSupabaseAuthParent`, `requireLinkedSeed`) |
