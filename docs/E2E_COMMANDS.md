...
| `POST /api/test/setup-public-store-scenario` | `public-store.spec.ts`, `public-store-share.spec.ts`, `public-store-affiliate.spec.ts`, `parent-supply-list.spec.ts` (empty nav) |
