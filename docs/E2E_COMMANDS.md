...
| [`e2e/school-admin-education-standards.spec.ts`](../e2e/school-admin-education-standards.spec.ts) | `npm run test:e2e -- e2e/school-admin-education-standards.spec.ts` | Standards catalog tab + `/api/education-standards` (NY/National) | `setup-progress-scenario` (`linkSupabaseAuthAdmin`) |
| [`e2e/school-admin-progress-insights-kpi.spec.ts`](../e2e/school-admin-progress-insights-kpi.spec.ts) | `npm run test:e2e -- e2e/school-admin-progress-insights-kpi.spec.ts` | Progress Insights jurisdiction badge + cohort median Lexile | `setup-progress-scenario` (`linkSupabaseAuthAdmin`) |
| [`e2e/school-admin-student-progress-charts.spec.ts`](../e2e/school-admin-student-progress-charts.spec.ts) | `npm run test:e2e -- e2e/school-admin-student-progress-charts.spec.ts` | Progress Insights individual + multi-select Lexile line charts | `setup-progress-scenario` (`linkSupabaseAuthAdmin`) |
