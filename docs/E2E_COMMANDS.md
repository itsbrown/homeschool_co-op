...
| [`e2e/school-admin-supply-list.spec.ts`](../e2e/school-admin-supply-list.spec.ts) | `npm run test:e2e -- e2e/school-admin-supply-list.spec.ts` | Class Supplies tab + session Supplies dialog; link affiliate shop product | `setup-supply-list-scenario` (`linkSupabaseAuthAdmin`) |
