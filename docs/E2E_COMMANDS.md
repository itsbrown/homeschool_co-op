...
| `POST /api/test/setup-schedule-builder-scenario` | `schedule-builder-publish`, `parent-weekly-schedule`, `parent-family-calendar`, `parent-dashboard-upcoming-events`, `parent-calendar-redirects`, `school-admin-calendar`, `parent-progress-scheduled-lessons`, `school-admin-academics-kpi`, `schedule-template-csv-import`, `educator-weekly-schedule-plans`, `educator-landing-nav`, `educator-mentor-loop`, `educator-today-honesty`, `attendance-educator-mark`, `attendance-roster-levels`, `attendance-qr-clock-in` |
